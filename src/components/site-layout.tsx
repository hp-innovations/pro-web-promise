      ...
      <div className="container-tight flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center rounded-full border-[3px] border-ink md:hidden"
            onClick={() => setOpen(!open)}
          >
            {open ? <X className="h-6 w-6" strokeWidth={3.5} /> : <Menu className="h-6 w-6" strokeWidth={3.5} />}
          </button>
        </div>
      </div>
